      ...
      <Dialog open={showWarningDialog} onOpenChange={() => { }}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              You've been idle for a long time. You will be automatically logged out in{" "}
              <span className="font-bold text-red-600">{dialogCountdown}</span> seconds.
              <br /><br />
              <span className="text-sm text-gray-600">
                Do any activity (click, move mouse, type) to keep your session active.
              </span>
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
